...
- Pending global ban requests are stored there too, so owner approval buttons survive restarts.
...
- `GLOBAL_BAN_REQUEST_PING_USER_ID` can point to one user ID to ping whenever `/gbanrequest` is submitted.
